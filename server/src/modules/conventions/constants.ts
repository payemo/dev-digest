 ...
 * order; missing ones are skipped silently — most repos have only a handful.
 */
...
/** Canonical skill name this feature always produces (spec-mandated, not user-editable end state). */
